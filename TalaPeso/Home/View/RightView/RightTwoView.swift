...
class RightTwoView: UIView {
    ...
    lazy var label2: UILabel = {
        ...
        label2.text = "United Srj Lending Investor Corp."
        return label2
    }()
    ...
    lazy var label8: UILabel = {
        ...
        label8.text = "Bugo, Cagayan De Oro City, Misamis Oriental, Philippines"
        return label8
    }()
    ...
    lazy var label10: UILabel = {
        ...
        label10.text = "https://www.unitedsrj.com"
        return label10
    }()
