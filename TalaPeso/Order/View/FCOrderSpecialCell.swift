...
class FCOrderSpecialCell: UITableViewCell {
    ...
    lazy var bgImageView: UIImageView = {
        ...
        bgImageView.image = UIImage(named: "speceilacellIMage")
        return bgImageView
    }()
    ...
    lazy var titleLabel: FFShadowLabel = {
        ...
        titleLabel.font = UIFont(name: Fredoka_Bold, size: 24.px())
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        redImageView.addSubview(titleLabel)
        ...
        titleLabel.snp.makeConstraints { make in
            ...
            make.top.equalToSuperview().offset(8.px())
            make.height.equalTo(29.px())
        }
        label1.snp.makeConstraints { make in
            make.top.equalTo(redImageView.snp.bottom)
    ...
    var model: PlaceModel? {
        didSet {
            ...
            if anemic == "180" {//红色
                redImageView.image = UIImage(named: "Slicebgred")
            }else {
                redImageView.image = UIImage(named: "Slicecellblack")
            }
        }
    }
